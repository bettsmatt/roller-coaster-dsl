 ...
 * <ul>
 *   <li>{@link org.xtext.rollercoaster.dsl.coaster.impl.GreetingImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GreetingImpl extends MinimalEObjectImpl.Container implements Greeting
{
  ...
  {
    return CoasterPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoasterPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CoasterPackage.GREETING__NAME:
        return getName();
    }
